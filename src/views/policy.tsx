...
export default function PolicyPage({
  ...
  const sections: Record<"about" | "terms" | "privacy", [string, ReactNode][]> =
    {
      about: [
        [
          t("项目简介"),
        ...
        [
          ...
          <div className="space-y-1.5">
            <p>
              {t(
                "本项目基于开源生态构建与部署，特别致谢原项目作者及开源仓库：",
              )}
              <a
                href="https://github.com/zhihui-hu/one-ip"
                target="_blank"
                rel="noopener noreferrer"
                className="mx-1 inline-flex items-center font-medium text-primary hover:underline"
              >
                GitHub / one-ip
              </a>
              。
            ...
            <p className="text-xs text-muted-foreground/80">
              {t("感谢原作者 @zhihui-hu 以及开源社区各位贡献者的支持与付出。")}
            </p>
          </div>,
        ],
      ],
